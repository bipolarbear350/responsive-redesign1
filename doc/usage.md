...
table of contents](responsive-redesign1/doc/TOC.md)
...
CSS](responsive-redesign1/doc/css.md).
...
get you started. [About the JavaScript](responsive-redesign1/doc/js.md).
...
[Read more about the `.editorconfig` file](responsive-redesign1/doc/misc.md#editorconfig).
...
refer to the [according documentation](responsive-redesign1/doc/extend.md#apple-touch-icons).
